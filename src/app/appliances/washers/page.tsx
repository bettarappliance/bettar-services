...
export default function WashersPage() {
  ...
  useEffect(() => {
    const fetchAppliances = async () => {
      try {
        ...
        const q = query(ref, where("category", "==", "Washer"));
        ...
        console.error("Error loading washers from Firestore", error);
      } finally {
  ...
  const categorySchema = {
    ...
    "@type": "CollectionPage",
    "name": "Washers",
    "description": "Shop quality washers from top brands. Professional washer sales, installation, and repair in Bethesda, Chevy Chase, Rockville, Kensington, Potomac, Olney, Gaithersburg, and Germantown, MD.",
    "url": "https://bettarservices.com/appliances/washers",
  };
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-4">
              <span className="text-[#002D72]">Washers</span>
            </h1>
        ...
        <div className="w-full flex-1 space-y-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Showing {appliances.length} washer{appliances.length !== 1 ? 's' : ''}
            </p>
          </div>

          {loadingAppliances ? (
            <p className="text-gray-600 text-center py-8">Loading washers…</p>
          ) : appliances.length === 0 ? (
            <p className="text-gray-600 text-center py-8">
              No washers available at the moment.
            </p>
          ) : (
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2">
              Need help choosing a washer?
            </h2>
            <p className="text-sm md:text-base text-[#E0E7FF] max-w-xl">
              Our team can help you find the perfect washer for your home. Contact us today!
            </p>
          </div>
          <button
            onClick={() => setIsApplianceModalOpen(true)}
