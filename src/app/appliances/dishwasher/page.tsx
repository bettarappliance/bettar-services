...
export default function DishwasherPage() {
  ...
  useEffect(() => {
    const fetchAppliances = async () => {
      try {
        ...
        const q = query(ref, where("category", "==", "Dishwasher"));
        ...
        console.error("Error loading dishwashers from Firestore", error);
      } finally {
  ...
  const categorySchema = {
    ...
    "@type": "CollectionPage",
    "name": "Dishwashers",
    "description": "Shop quality dishwashers from top brands. Professional dishwasher sales, installation, and repair in Bethesda, Chevy Chase, Rockville, Kensington, Potomac, Olney, Gaithersburg, and Germantown, MD.",
    "url": "https://bettarservices.com/appliances/dishwasher",
  };

  return (
    <div className="min-h-screen bg-white">
      <Script
        id="dishwasher-schema"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-4">
              <span className="text-[#002D72]">Dishwashers</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find the perfect dishwasher for your kitchen. From built-in to portable models, we offer quality dishwashers from top brands with professional installation and repair services.
            </p>
            <div className="mt-8">
              <button
        ...
        <div className="w-full flex-1 space-y-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Showing {appliances.length} dishwasher{appliances.length !== 1 ? 's' : ''}
            </p>
          </div>

          {loadingAppliances ? (
            <p className="text-gray-600 text-center py-8">Loading dishwashers…</p>
          ) : appliances.length === 0 ? (
            <p className="text-gray-600 text-center py-8">
              No dishwashers available at the moment.
            </p>
          ) : (
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2">
              Need help choosing a dishwasher?
            </h2>
            <p className="text-sm md:text-base text-[#E0E7FF] max-w-xl">
              Our team can help you find the perfect dishwasher for your kitchen. Contact us today!
            </p>
          </div>
          <button
            onClick={() => setIsApplianceModalOpen(true)}
