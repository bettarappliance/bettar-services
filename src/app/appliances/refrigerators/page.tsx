...
export default function RefrigeratorsPage() {
  ...
  useEffect(() => {
    const fetchAppliances = async () => {
      try {
        ...
        const q = query(ref, where("category", "==", "Refrigerator"));
        ...
        console.error("Error loading refrigerators from Firestore", error);
      } finally {
  ...
  const categorySchema = {
    ...
    "@type": "CollectionPage",
    "name": "Refrigerators",
    "description": "Shop quality refrigerators from top brands. Professional refrigerator sales, installation, and repair in Bethesda, Chevy Chase, Rockville, Kensington, Potomac, Olney, Gaithersburg, and Germantown, MD.",
    "url": "https://bettarservices.com/appliances/refrigerators",
  };

  return (
    <div className="min-h-screen bg-white">
      <Script
        id="refrigerators-schema"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-4">
              <span className="text-[#002D72]">Refrigerators</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find the perfect refrigerator for your home. From French door to side-by-side models, we offer quality refrigerators from top brands with professional installation and repair services.
            </p>
            <div className="mt-8">
              <button
        ...
        <div className="w-full flex-1 space-y-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Showing {appliances.length} refrigerator{appliances.length !== 1 ? 's' : ''}
            </p>
          </div>

          {loadingAppliances ? (
            <p className="text-gray-600 text-center py-8">Loading refrigerators…</p>
          ) : appliances.length === 0 ? (
            <p className="text-gray-600 text-center py-8">
              No refrigerators available at the moment.
            </p>
          ) : (
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm md:text-base text-[#E0E7FF] max-w-xl">
              Our team can help you find the perfect refrigerator for your home. Contact us today!
            </p>
          </div>
          <button
            onClick={() => setIsApplianceModalOpen(true)}
