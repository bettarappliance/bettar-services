...
export default function MicrowavePage() {
  ...
  useEffect(() => {
    const fetchAppliances = async () => {
      try {
        ...
        const q = query(ref, where("category", "==", "Microwave"));
        ...
        console.error("Error loading microwaves from Firestore", error);
      } finally {
  ...
  const categorySchema = {
    ...
    "@type": "CollectionPage",
    "name": "Microwaves",
    "description": "Shop quality microwaves from top brands. Professional microwave sales, installation, and repair in Bethesda, Chevy Chase, Rockville, Kensington, Potomac, Olney, Gaithersburg, and Germantown, MD.",
    "url": "https://bettarservices.com/appliances/microwave",
  };
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl font-bold text-black mb-4">
              <span className="text-[#002D72]">Microwaves</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find the perfect microwave for your kitchen. From countertop to over-the-range models, we offer quality microwaves from top brands with professional installation and repair services.
            </p>
            <div className="mt-8">
              <button
        ...
        <div className="w-full flex-1 space-y-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Showing {appliances.length} microwave{appliances.length !== 1 ? 's' : ''}
            </p>
          </div>

          {loadingAppliances ? (
            <p className="text-gray-600 text-center py-8">Loading microwaves…</p>
          ) : appliances.length === 0 ? (
            <p className="text-gray-600 text-center py-8">
              No microwaves available at the moment.
            </p>
          ) : (
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2">
              Need help choosing a microwave?
            </h2>
            <p className="text-sm md:text-base text-[#E0E7FF] max-w-xl">
              Our team can help you find the perfect microwave for your kitchen. Contact us today!
            </p>
          </div>
          <button
            onClick={() => setIsApplianceModalOpen(true)}
